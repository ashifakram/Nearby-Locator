...
export default function BotAvatar({ isDark }) {
  return (
    <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 via-blue-500 to-blue-600 flex items-center justify-center shadow-lg flex-shrink-0 ring-2 ${isDark ? 'ring-cyan-400/50' : 'ring-cyan-300/50'}`}>
